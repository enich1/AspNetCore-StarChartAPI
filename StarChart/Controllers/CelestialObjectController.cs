...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        {
            var celestrialObjects = _context.CelestialObjects.Where(e => e.Name == name).ToList();
            if (!celestrialObjects.Any())
                return NotFound();
        ...
        {
            var celstialObjects = _context.CelestialObjects.Where(e => e.Id == id || e.OrbitedObjectId == id);
            if (!celstialObjects.Any())
                return NotFound();
